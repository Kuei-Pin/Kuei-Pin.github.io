...
$("figure").unbind("dblclick").bind("dblclick", function () { //双击事件
  ...
  if (block != 1) {
    ...
    BindScrollTo($(this).find(".code")[0]);
    $(this).attr("block", 1);
    $(this).find(".codePinBtn img").attr("src", "/images/icons/Pin_red.png");
  } else {
    UnBindScroll();
    $(this).attr("block", 0);
    $(this).find(".codePinBtn img").attr("src", "/images/icons/Pin_green.png");
  }
})
...
function createCopyBtns() {
  ...
  if ($figure.length > 0) {
    ...
    $figure.append('<div class="codePinBtn"><img id="imgSuccess" src="/images/icons/Pin_green.png" style="border:none; width: 24px;"></div>');
  }
...
function btnPinClick() {
  ...
  if (block != 1) {
    ...
    $(figure).attr("block", 1);
    $(this).find("img").attr("src", "/images/icons/Pin_red.png");
  } else {
    UnBindScroll();
    $(figure).attr("block", 0);
    $(this).find("img").attr("src", "/images/icons/Pin_green.png");
  }
}
